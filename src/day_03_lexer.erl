-file("/opt/homebrew/Cellar/erlang/27.3.4/lib/erlang/lib/parsetools-2.6/include/leexinc.hrl", 0).
...
-file("src/day_03_lexer.xrl", 18).

-file("/opt/homebrew/Cellar/erlang/27.3.4/lib/erlang/lib/parsetools-2.6/include/leexinc.hrl", 14).
...
yystate(13, [109|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(9, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [100|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [44|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(13, [43|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [41|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(3, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [40|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(13, [13|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(11, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [11|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [12|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [10|Ics], Line, _, Tlen, Action, Alen) ->
    yystate(11, Ics, Line+1, 1, Tlen+1, Action, Alen);
yystate(13, [9|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(11, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 0, C =< 8 ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 33, C =< 39 ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 45, C =< 47 ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(4, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 58, C =< 99 ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 101, C =< 108 ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(13, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 110 ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(11, [32|Ics], Line, Col, Tlen, _, _) ->
    yystate(11, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(11, [13|Ics], Line, Col, Tlen, _, _) ->
    yystate(11, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(11, [9|Ics], Line, Col, Tlen, _, _) ->
    yystate(11, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(11, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(11, Ics, Line+1, 1, Tlen+1, 7, Tlen);
...
yystate(2, [111|Ics], Line, Col, Tlen, _, _) ->
    yystate(6, Ics, Line, Col, Tlen+1, 8, Tlen);
...
-file("src/day_03_lexer.xrl", 6).
yyaction_0(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/1}).
-file("src/day_03_lexer.xrl", 7).
yyaction_1(TokenLine) ->
     { token, { mul, TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/day_03_lexer.xrl", 8).
yyaction_2(TokenLine) ->
     { token, { do, TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/day_03_lexer.xrl", 9).
yyaction_3(TokenLine) ->
     { token, { dont, TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/day_03_lexer.xrl", 10).
yyaction_4(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/day_03_lexer.xrl", 11).
yyaction_5(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/day_03_lexer.xrl", 12).
yyaction_6(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/day_03_lexer.xrl", 13).
yyaction_7(TokenLine) ->
     { token, { whitespace, TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("src/day_03_lexer.xrl", 14).
yyaction_8(TokenLine) ->
     { token, { junk, TokenLine } } .
-file("/opt/homebrew/Cellar/erlang/27.3.4/lib/erlang/lib/parsetools-2.6/include/leexinc.hrl", 344).
